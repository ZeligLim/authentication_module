...
/**
 * Application user. Password may be empty for OAuth2- or magic-link-only accounts.
 * {@link #mfaEnabled} gates whether login returns an MFA challenge instead of tokens.
 */
@Entity
@Table(name = "users")
@Data
